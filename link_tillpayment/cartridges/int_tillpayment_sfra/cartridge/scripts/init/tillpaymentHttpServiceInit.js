...
/*
*    Communicates with Tillpayments API For APM
*/
tillpaymentsHttpService.apmServiceCall = function (method, endPoint, requestBody, authToken) {
    var endPointUrl = endPoint;
    var serviceArgs;
    var localService;
    var requestParam;
    localService = LocalServiceRegistry.createService('tillpayments.api.apm.service', {
        createRequest: function (service, args) {
            service.setURL(service.configuration.credential.URL + args.endPointUrl);
            service.setRequestMethod(args.method);
            service.addHeader('Authorization', args.auth);
