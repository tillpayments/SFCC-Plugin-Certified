...
function processForm(req, paymentForm, viewFormData) {
    ...
    if (viewData.storedPaymentUUID
        ...
        viewData.paymentInformation.tillpaymentRegistrationID = paymentInstrument.raw.custom.tillpaymentRegistrationID;
    }
...
function savePaymentInformation(req, basket, billingData) {
    ...
    if (!billingData.storedPaymentUUID
        ...
        Transaction.wrap(function () {
            basket.custom.tillpaymentCustomerPaymentInstrumentUUID = saveCardResult.UUID; // eslint-disable-line no-param-reassign
        });
    ...
    if (billingData.storedPaymentUUID
            && !billingData.paymentInformation.tillpaymentRegistrationID) {
        Transaction.wrap(function () {
            basket.custom.tillpaymentCustomerPaymentInstrumentUUID = billingData.storedPaymentUUID; // eslint-disable-line no-param-reassign
        });
    }
}
